...
<script type="text/javascript">
	...
	<div class="main-content-inner" style="background-color:#aaa">
    ...
    <div class="row">
        <div class="col-sm-9 widget-container-col" align="center">
            <div class="widget-box transparent panel panel-default">
...
<br>
    ...
    <li class="">
	<a href="{{ route('nivel_estudiantes.index') }}">
	<i class="menu-icon fa fa-caret-right"></i>
	Nivel Estudiantes</a>
    </li>
    <li class="">
	...
	Formularios</a></li>
	<li class="">
	<a href="{{ route('notas_bloque.index') }}">
	<i class="menu-icon fa fa-caret-right"></i>
	Salir</a></li>
	</ul>
    </li>
    ...
    elseif(session('perfil')=='Estudiante'){
	...
	<div class="col-sm-9 widget-container-col" align="center">
		...
		<div class="widget-header panel panel-default">
				{{ session('login')}} 
				@else {{route('notas_bloque')}} 
				@endif 

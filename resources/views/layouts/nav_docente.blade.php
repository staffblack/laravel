...
<div align="center">
 ...
 <?php 
  ...
  <br><br><br>
		...
		<a href="nuestro_colegio" class="dropdown-toggle">
			...
			<li class="">
                ...
                <ul class="submenu">
			<li class="">
                            <a href="evento?search=Actividad">
                                Minitos Civicos
                            </a>
                            <b class="arrow"></b>
                        </li>
  ...
  ?>
        <div class="panel panel-info">
            &nbsp;&nbsp;&nbsp;&nbsp;
            <h8 id="heading"><span class="glyphicon glyphicon-hand-right">
                </span> <a href="{{ action('T_docenteController@index', ['cedula_docente' => session('login')]) }}" id="heading">&nbsp;&nbsp;Cuenta</a>
            </h8>
        </div>
        <div class="panel panel-info">
            &nbsp;&nbsp;&nbsp;&nbsp;

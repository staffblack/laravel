      ...
      <table width="1000" border="0" cellspacing="3">
          <tr>
            <td width="190" rowspan="2" align="left" valign="top"><table width="150" border="0" cellspacing="3">
              ...
              <table width="134" bgcolor="#EFEFEF">
                <tr>
                  <td width="118"><ul class="nav nav-list" >
                    <li class=""><a href="docentes?cedula_docente={{session('login')}}">Mi cuenta </a></li>
                    <li class=""> <a href="nota_estudiante"> Notas de Bloque </a> </li>
                    <li class=""><a href="horario_docente"> Horario Docente </a></li>
                    <li class=""><a href="notas_bloque"> Salir </a></li>
                    </ul>	</td>
                </tr>
              </table></td>
            <td valign="top"><span class="Estilo30"><a href="nota_estudiante">Notas de bloque </a>-&gt; <span class="Estilo16"><a href="materia_docentes?id_nivel={{$id_nivel}}&&descripcion_nivel={{$descripcion_nivel}}" >{{$id_nivel.' '. $descripcion_nivel }}</a></span> -&gt; <a href="estudiante_docentes?id_nivel={{$id_nivel}}&&descripcion_nivel={{$descripcion_nivel}}&&id_materia={{$id_materia}}&&nombre_materia={{$nombre_materia}}" > {{$id_materia.' '.$nombre_materia}} </a>-&gt; Editar </span></td>
          </tr>
          <tr>
            <td width="797" valign="top"><form name="form1" method="post" action="/portal/public/ingresar_bloque">
              <p>{{ csrf_field() }} 
                <input name="id_nivel" type="hidden" id="id_nivel" value="{{$id_nivel}}">
                <span class="text-center Estilo20 Estilo16">
                <input type="hidden" name="descripcion_nivel" id="descripcion_nivel" value="{{$descripcion_nivel}}" >
                </span><span class="text-center Estilo20 Estilo16">
                <input type="hidden" name="id_materia" id="id_materia" value="{{$id_materia}}" >
                </span><span class="text-center Estilo20 Estilo16">
                <input type="hidden" name="nombre_materia" id="nombre_materia" value="{{$nombre_materia}}" >
                </span><span class="text-center Estilo20 Estilo16">
                <input type="hidden" name="cant" id="cant" value="{{$cant=1}}" >
                </span><span class="text-center Estilo20 Estilo16">
                <input type="hidden" name="numnota" id="nunnota" value="{{$numnota}}" >
                </span><span class="text-center Estilo20 Estilo16">
                <input type="hidden" name="var" id="var" value="{{$var=''}}" >
                </span></p>
              <table width="700" class="table table-bordered" id="tableMonedas">
                <thead>
                  <tr>
                    ...
                    <th width="242" class="text-center Estilo20 Estilo16">Bloque</th>
                    </tr>
                  <tr>
                    <td class="text-center"><div align="center">B{{$numnota}}</div></td>
                    </tr>
                </thead>
                <tbody>           
                ...
                <tr>
                  <td  width="180" class="text-center Estilo20 Estilo16">{{$estudiante->cedula}}</td>
                  <td width="180" class="text-center"><span class="text-center Estilo20 Estilo16">{{$estudiante->nombres}}</span></td>
                  <td width="180" class="text-center"><span class="text-center Estilo20 Estilo16">{{$estudiante->apellidos}}</span></td>
                  <td width="242" align="center" class="text-center">
							  
				    <div align="center">@if (count ($notas)>0)
				      @foreach($notas as $nota)
				      @if ($estudiante->cedula==$nota->cedula)
				      @if ($numnota==1)
				      <input type="hidden" name="var" id="var" value="{{$var=$nota->nota1}}" >
				      @endif
				      @if ($numnota==2)
				      <input type="hidden" name="var" id="var" value="{{$var=$nota->nota2}}" >
				      @endif
				      @if ($numnota==3)
				      <input type="hidden" name="var" id="var" value="{{$var=$nota->nota3}}" >
				      @endif
				      
				      @if ($numnota==4)
				      <input type="hidden" name="var" id="var" value="{{$var=$nota->nota4}}" >
				      @endif
				      @if ($numnota==5)
				      <input type="hidden" name="var" id="var" value="{{$var=$nota->nota5}}" >
				      @endif
				      @if ($numnota==6)
				      <input type="hidden" name="var" id="var" value="{{$var=$nota->nota6}}" >
				      @endif
				      @endif
				      @endforeach
				      @endif
				      
				      <input name="nota{{$cant++}}" type="text" id="nota" value="{{$var}}" size="5">				      
				      </div></td>
                  </tr>
                <tr>
				@endforeach
				
    <td  width="181" height="26"  class="text-center Estilo20 Estilo16">&nbsp;</td>
    <td width="199" class="text-center">&nbsp;</td>
    <td width="197" class="text-center">&nbsp;</td>
    <td width="242" class="text-center"><div align="center">

            ...
            <div class="col-lg-10 panel panel-default">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/cronograma-secretaria/' . $cronogramasecretarium->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}

                            @include ('cronograma-secretaria.form', ['formMode' => 'edit'])
